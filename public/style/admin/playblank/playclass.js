...
function PlayHistoryClass() {
	...
	this.getPlayArray = function() {
		...
		var start = cookieStr.indexOf("zanpian_vod_v=") + "zanpian_vod_v=".length, end = cookieStr
	...
	this.addPlayHistory = function(json,vod_readurl,vod_palyurl) {
		...
		if ((cookieStr.indexOf("zanpian_vod_v=") != -1 || cookieStr.indexOf("_$_|") != -1) && allVideoArray != undefined) {
			var newCookieStr = "";
			...
			document.cookie = "zanpian_vod_v=" + newCookieStr + code_name + code_url + timeAndPathStr;
		} else {
			document.cookie = "zanpian_vod_v=" + code_name + code_url + timeAndPathStr;
		}
	}
