...
(function($, window)
{
    ...
    var id = 0;
    var template = '<div class="messager messager-{type} {placement}" id="messager{id}" style="display:none"><div class="messagerbg"><div class="ui-dialog-tip {type}" id="ui-cnt"><div class="messager-content"></div></div><div class="ui-dialog-close"><span class="close">¹Ø±Õ</span></div></div></div>';
    var defaultOptions =
    {
        type: 'default',
        placement: 'top',
