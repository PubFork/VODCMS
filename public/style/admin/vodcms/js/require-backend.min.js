...
require.config({
    ...
    paths: {
		...
		'bootstrap-editable': '../libs/bootstrap-editable/bootstrap-editable.min',
		...
		'template': '../libs/art-template/dist/template-native',
		'messager': '../libs/board/messager',
		'droppable': '../libs/board/droppable',
		'board': '../libs/board/board.min',	
		'bigcolorpicker': '../libs/bigcolorpicker/jquery.bigcolorpicker.min',	
    },
    // shim依赖配置
    shim: {
        'bootstrap': ['jquery'],
...
//            'css!../libs/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css',
		...
		'bootstrap-editable': ['css!../libs/bootstrap-editable/bootstrap-editable.css', ],
...
//        'validator-core': ['css!../libs/nice-validator/dist/jquery.validator.css'],
		...
		'board': ['css!../libs/board/board.min.css', ],
		'bigcolorpicker': ['css!../libs/bigcolorpicker/jquery.bigcolorpicker', ],
//        'selectpage': ['css!../libs/selectpage/selectpage.css'],
    },
    baseUrl: requirejs.s.contexts._.config.config.site.cdnurl + 'admin/vodcms/js/', //资源基础路径
    map: {
        '*': {
...
define('fast',['jquery', 'bootstrap', 'toastr', 'layer', 'lang'], function ($, undefined, Toastr, Layer, Lang) {
    var Fast = {
        ...
        api: {
                ...
                options = $.extend({
                    ...
                    success: function (ret) {
                        ...
                        if (ret.code === 1) {
							...
							if(ret.url){
								if($(".ajax-no-close").size()>0){
								  location.href = ret.url;
						        }else if($(".ajax-no").size()>0){
									parent.$.get(ret.url,function(data,status) {			   
	                                     var value=jQuery('#contents', data).html(); 
	                                      parent.$("#contents").html(value);	
	                                });	
									}
								else{	
							      parent.pagegooo(ret.url)
								}
							}
                        } else {
            ...
            //打开一个弹出窗口
            open: function (url, title, options,width,height) {
                title = title ? title : "";
                url = Fast.api.fixurl(url);
                url = url + (url.indexOf("?") > -1 ? "&" : "?") + "dialog=1";
				width=$(window).width() > 800 ? '800px' : '90%';
        ...
        api: {
            sidebar: function (params) {
                ...
                $.each(badgeList, function (k, v) {
                    var anchor = top.window.$("li a[addtabs][data='" + k + "']");
                    if (anchor) {
...
define('table', ['jquery', 'bootstrap', 'moment', 'moment/locale/zh-cn', 'bootstrap-table', 'bootstrap-table-lang', 'bootstrap-editable'], function($, undefined, Moment) {
	var Table = {
		api: {
			init: function(defaults, columnDefaults, locales) {},
			bindevent: function(table) {
				$(document).on("click", "[data-url].btn-detail,[data-url].btn-editone", function(e) {
					var url = $(this).data("url");
					var name = $(this).data("name");
					var width = $(this).data("width");
					var height = $(this).data("height");
					Backend.api.open(url, name,'',width,height);
				});
                var refreshkey = function (data) {
                   Toastr.success(data.msg ? data.msg : '操作成功'); 
                };				
				$(document).on("click", "[data-url].btn-editones", function(e) {
					var url = $(this).data("url");
					var name = $(this).data("name");
					Backend.api.open(url, name);
				});				
				$(document).on("change", "select[type='get-select']", function() {
					var that = this;
					if ($(this).val()) {
						pagegooo($(this).val())
						Toastr.success('筛选完成');
				...
				$(document).on("click", '.hidedsearch', function(e) {
							...
							layer.confirm('确认要执行该操作吗?', {
								...
								$.post(target, query).success(function(data) {
									if (data.code == 1) {
										...
										$('.btn-disabled').removeClass('disabled').prop('disabled', false);
										$('#selectedChks').hide();
									}
								});
							});
				...
				$(document).on("click", ".ajax-posturl", function(e) {
					var target, query, form;
					var target_form = $(this).attr('target-form');
					var that = this;
					var nead_confirm = false;
			...
			$(document).on('click', ".setstars", function() {
				var arr = $(this).attr('id');
				var index = arr.split("_");
				$.ajax({
					url: index[0] + '/stars',
					data: {id: index[1],stars: index[2]},
					type: 'post',
					dataType: 'json',
					success: function(data) {
						if (data.code === 1) {
							for (i = 1; i <= 5; i++) {
								$('#' + index[0] + '_' + index[1] + '_' + i).attr("src", requirejs.s.contexts._.config.config.site.cdnurl+"admin/vodcms/img/star0.gif");
							}
							for (i = 1; i <= index[2]; i++) {
								$('#' + index[0] + '_' + index[1] + '_' + i).attr("src",requirejs.s.contexts._.config.config.site.cdnurl+"admin/vodcms/img/star1.gif");
							}
							Toastr.success(data.msg ? data.msg : '操作成功');
						} else {
                            Toastr.error(data.msg ? data.msg : '操作失败');
...
function relation_ajax($nid,$tid,$did,$type,$lastdid,$model,$sid) {
	$.ajax({
		type: 'get',
		cache: false,
		url: $model + '/ajax-type-' + $type + '-sid-' + $sid + '-nid-' + $nid + '-tid-' + $tid + '-did-' + $did + '-lastdid-' + $lastdid+".html",
            ...
            plupload: function (element, onUploadSuccess, onUploadError) {
                ...
                $(element, Upload.config.container).each(function () {
                    ...
                    Upload.list[id] = new Plupload.Uploader({
                        ...
                        flash_swf_url: '/tpl/admin/vodcms/libs/plupload/js/Moxie.swf',
                        silverlight_xap_url: '/tpl/admin/vodcms/libs/plupload/js/Moxie.xap',
                        filters: {
                    ...
                    if (preview_id && input_id) {
                        $(document.body).on("keyup change", "#" + input_id, function () {
                            ...
                            $.each(inputArr, function (i, j) {
                                ...
                                var data = {url: j, fullurl: Fast.api.uploadcdnurl(j), data: $(that).data()};
        ...
        events: {
                                ...
                                onImageUpload: function (files) {
                                    ...
                                    for (var i = 0; i < files.length; i++) {
                                        Upload.api.send(files[i], function (data) {
                                            var url = Fast.api.uploadcdnurl(data.url);
            ...
            bindevent: function (form) {
			    $(document).on('click', ".addstars", function() {
				      ...
				      var index = arr.split("_");
				      for (i = 1; i <= 5; i++) {
					    $('#' + index[0] + '_' + i).attr("src", requirejs.s.contexts._.config.config.site.cdnurl+"admin/vodcms/img/star0.gif");
				      }
				     for (i = 1; i <= index[1]; i++) {
					    $('#' + index[0] + '_' + i).attr("src",requirejs.s.contexts._.config.config.site.cdnurl+"admin/vodcms/img/star1.gif");
			          }
